                    ...
                    try {
                        ...
                        switch (e.getType()) {
                            case GOOGLE_ACCOUNT_NOT_SET:
                                notifier.onSubmission(true, context.getString(org.odk.collect.strings.R.string.google_set_account));
                                break;
                            case GOOGLE_ACCOUNT_NOT_PERMITTED:
                                notifier.onSubmission(true, context.getString(org.odk.collect.strings.R.string.odk_permissions_fail));
                                break;
